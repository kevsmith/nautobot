...
| 56 | [Prefetch the home page changelog panel's generic foreign key](methodology.md#prefetch-the-home-page-changelog-panels-generic-foreign-key) | `A` | attribution: 25 of the home page's 79 queries are one panel rendering 15 rows | `f1b5f335f` |
