...
| Changes proposed | 39 |
| Accepted on this branch | **27** |
| Rejected | 12 |
| Experiments recorded | 54, of which 15 measured the harness itself |
...
| 54 | [Route TenantColumn through the caching TemplateColumn](methodology.md#route-tenantcolumn-through-the-caching-templatecolumn) | `A` `third-party-coupled` | attribution: 100 template compilations per 100-row page, one per cell, from one column | `8b4e351b2` |
