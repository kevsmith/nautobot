...
| Changes proposed | 37 |
| Accepted on this branch | **25** |
| Rejected | 12 |
| Experiments recorded | 51, of which 14 measured the harness itself |
...
| 51 | [Resolve the navbar-favorites URLs once per process, not once per menu item](methodology.md#resolve-the-navbar-favorites-urls-once-per-process-not-once-per-menu-item) | `B2` | −43.0% on a chrome-only response; 387 URL reversals per page become 18 | `ffb785bd1` |
