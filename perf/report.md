...
| 53 | [Select_related the device list's primary IPs, which its own table cannot see](methodology.md#select-related-the-device-lists-primary-ips-which-its-own-table-cannot-see) | `A` | attribution: 100 ipam_ipaddress queries on a 100-row page, all from one property | `5f8c5f643` |
