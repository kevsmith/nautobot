...
seconds, and perf/scripts/reset_db.sh does the same job in 1.3 by cloning a template.
See finding 33.

    perf/scripts/dc.sh exec -T nautobot python /source/perf/scripts/probe_commit_cost.py --arm rollback
"""
