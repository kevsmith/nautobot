...
POST is rolled back, so it leaves no cables behind.
    ...
    perf/scripts/dc.sh exec -T nautobot python /source/perf/scripts/probe_cable_bulk.py
"""
    ...
    if args.from_existing:
        ...
        if args.dump:
            ...
            if args.free_terminations:
                ...
                print(f"DELETED {deleted} rows to free the terminations -- run perf/scripts/reset_db.sh when finished")
            return
