...
finding 27 was declined at a measured 3.1%.
    ...
    perf/scripts/dc.sh exec -T nautobot python /source/perf/scripts/probe_index_cost.py --arm with
    perf/scripts/dc.sh exec -T nautobot python /source/perf/scripts/probe_index_cost.py --arm without
"""
