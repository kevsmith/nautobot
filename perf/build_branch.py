...
conflict stops the run and names the paths.
    ...
    python3 perf/build_branch.py                      # build perf/recommended
    python3 perf/build_branch.py --force              # delete and rebuild it
    python3 perf/build_branch.py --write-findings      # + record the new SHAs
